...
import "./ComplianceRiskAssessment.css";
        ...
        >
          <div className='row'>
            ...
            <div className='col-md-4'>
              ...
              <div className='form-group'>
                <label>
                  SOP Approval Date <b>*</b>
                </label>
                <input type='date' className='form-control mandatory' />
              </div>
              <div className='form-group'>
                <label></label>
                <select className='form-control'>
          ...
          <div className='row margin_top2'>
            <div className='col-md-4'>
              ...
              <div className='form-group'>
                ...
                <input type='number' className='form-control mandatory' />
              </div>
            </div>
            <div className='col-md-4'>
              <div className='form-group'>
          ...
          <div className='row margin_top2'>
            ...
            <div className='col-md-4'>
              ...
              <div className='form-group'>
                ...
                <input type='text' className='form-control mandatorys' />
              </div>
              <div className='form-group'>
                <label>View/Upload Documents</label>
                <input type='file' className='form-control' />
